...
![](Class18_pertussis_files/figure-commonmark/unnamed-chunk-2-1.png)
...
![](Class18_pertussis_files/figure-commonmark/unnamed-chunk-3-1.png)
...
Cases drop significantly after the implementation of the wP vaccine, but
when the aP vaccine is implemented, cases increase.

> Q3. Describe what happened after the introduction of the aP vaccine?
> Do you have a possible explanation for the observed trend?

Cases rose in the 1990s because there was a switch to the safer aP
vaccine, however, it was less effective in terms of its longevity of
protection which is shorter. It can also still be transmitted without
strong symptoms by vaccinated individuals and therefore could still
circulate. Around 2010, the implementation of boosters brought the cases
back down again.
...
\#CMI-PB project [Computational Models of Immunity - Pertussis
...
> Asian females, White males etc…)? Is it representative of the US
> population?
...
No this is absolutely not representative of the general US population.
...
Let’s focus on IgG antigen and make a plot of MFI_normalised for all
antigens.
...
![](Class18_pertussis_files/figure-commonmark/unnamed-chunk-15-1.png)
...
![](Class18_pertussis_files/figure-commonmark/unnamed-chunk-16-1.png)
...
![](Class18_pertussis_files/figure-commonmark/unnamed-chunk-17-1.png)
...
![](Class18_pertussis_files/figure-commonmark/unnamed-chunk-18-1.png)
...
![](Class18_pertussis_files/figure-commonmark/unnamed-chunk-20-1.png)

First evidence of significant difference in immune responses between two
vaccines.

Add plot from slides, geom_smooth.
...
ggplot(pt.igg.21) +
  ...
  geom_line() +
  geom_vline(xintercept = 14, col = "grey", lty=2) +
  geom_smooth(aes(group = infancy_vac, color = infancy_vac), se=FALSE, linewidth = 2) +
  labs(x = "Day Relative to Boost", y = "Normalized MFI", color = "Infancy Vaccine")
```

    `geom_smooth()` using method = 'loess' and formula = 'y ~ x'

![](Class18_pertussis_files/figure-commonmark/unnamed-chunk-21-1.png)

> Q18. Does this trend look similar for the 2020 dataset?

No, the normalised MFI for the wP vaccine is much lower, even though the
aP results are similar.

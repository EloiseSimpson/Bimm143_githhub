...
The data for today’s mini project comes from a knock-down study if an
important HOX gene.
...
![](class14_miniproject_files/figure-commonmark/unnamed-chunk-9-1.png)
...
![](class14_miniproject_files/figure-commonmark/unnamed-chunk-10-1.png)
...
```
    ...
    Info: Working in directory /Users/eloisesimpson/Documents/BIMM143/git_play/Bimm143_github/class14_miniproject.
...
> Q. Do the most significant pathways listed match your previous KEGG
> results? What factors could cause differences between the two methods?

Yes, the cell cycle aligns with meiosis and KEGG but the others do not
align as well. The factors which could cause differences between the two
methods are the fact that reactosome has more pathways that KEGG which
would effect the mapping and hence the results.
